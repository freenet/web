+++
title = "River: Real-Time Group Chat on Freenet"
date = 2025-12-25
author = "Ian Clarke"
author_link = "https://x.com/sanity"
tags = ["front-page"]
aliases = ["/news/river-realtime-chat-milestone/"]
+++
...
[River](https://github.com/freenet/river) is our test application for Freenet's core capabilities. It's very much a work in progress and not yet ready for general use, but it validates what we've been building toward: fully decentralized, scalable applications that feel responsive enough for real-time interaction.
