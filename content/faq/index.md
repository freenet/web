...
To ease the transition the old freenetproject.org domain was redirected
to hyphanet\'s website, while the recently acquired freenet.org domain
was used for the new architecture.
